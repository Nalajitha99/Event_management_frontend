      ...
      <div className="footer-contenrt">
        <div className="footer-content-left">
            ...
            <div className="footer-social-icons">
                <FaFacebookSquare style={{fontSize:"30px",marginRight:"5px"}} />
                <FaInstagramSquare style={{fontSize:"30px",marginRight:"5px"}}/>
                <FaSquareXTwitter style={{fontSize:"30px",marginRight:"5px"}} />
            </div>
        </div>
